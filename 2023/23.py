...
empty = {complex(x,y) for y,line in enumerate(lines) for x,c in enumerate(line) if c=='.'}
slopes = {complex(x,y):c for y,line in enumerate(lines) for x,c in enumerate(line) if c in '^><v'}
